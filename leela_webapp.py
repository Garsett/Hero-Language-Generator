...
# ===================================================================
# DE KENNISBANK (DATABASE) - NU MET THEORIE
# ===================================================================
leerstof_database = {
    "A1": {
        "themas": {
            ...
            "🏡 Familie & vrienden": {
                "uitleg": "Praten over je familie is een goede manier om te oefenen. Je leert de namen voor familieleden en hoe je relaties beschrijft.",
                "vocab": {"de familie": "family", "de vader": "father", "de moeder": "mother", "de broer": "brother", "de zus": "sister", "een vriend": "a friend"},
                "oefenzinnen": ["{naam} heeft een broer.", "De moeder van {naam} is lief.", "Ik stel mijn familie voor."]
            },
        },
        "grammatica": {
...
# ===================================================================
# DE OEFENING-GENERATORS - NU MET THEORIE
# ===================================================================
...
with st.sidebar:
    ...
    # Aangepaste standaardwaarde voor beroep
